...
class KeltnerAtrStrategy(CtaTemplate, SubmitTradeMixin):
    """Keltner/ATR Strategy"""

    author = "用Python的交易员"
    model_id = "ETHUSD_m1_Keltner_ATR_v1.0"
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        """"""
        super(KeltnerAtrStrategy, self).__init__(
    ...
    def on_bar(self, bar: BarData):
        ...
        upper, lower = am.keltner(self.keltner_window, self.keltner_dev)
